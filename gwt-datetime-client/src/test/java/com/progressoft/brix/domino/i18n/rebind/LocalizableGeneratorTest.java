...
import com.progressoft.brix.domino.i18n.FailErrorLogger;
import com.google.gwt.dev.util.UnitTestTreeLogger;
import com.progressoft.brix.domino.i18n.server.GwtLocaleFactoryImpl;
...
public class LocalizableGeneratorTest extends TestCase {
  ...
  private static final MockJavaResource LOCALIZABLE = new MockJavaResource(
      "com.progressoft.brix.domino.i18n.shared.Localizable") {
    @Override
    public CharSequence getContent() {
      StringBuffer code = new StringBuffer();
      code.append("package com.progressoft.brix.domino.i18n.shared;\n");
  ...
  private static final MockJavaResource LOCALIZABLE_RESOURCE = new MockJavaResource(
      "com.progressoft.brix.domino.i18n.client.LocalizableResource") {
    @Override
    public CharSequence getContent() {
      StringBuffer code = new StringBuffer();
      code.append("package com.progressoft.brix.domino.i18n.client;\n");
      code.append("import com.progressoft.brix.domino.i18n.shared.Localizable;\n");
  ...
  private static final MockJavaResource MESSAGES = new MockJavaResource(
      "com.progressoft.brix.domino.i18n.client.Messages") {
    @Override
    public CharSequence getContent() {
      StringBuffer code = new StringBuffer();
      code.append("package com.progressoft.brix.domino.i18n.client;\n");
  ...
  private static final MockJavaResource CONSTANTS = new MockJavaResource(
      "com.progressoft.brix.domino.i18n.client.Constants") {
    @Override
    public CharSequence getContent() {
      StringBuffer code = new StringBuffer();
      code.append("package com.progressoft.brix.domino.i18n.client;\n");
  ...
  private static final MockJavaResource TEST_MESSAGES = new MockJavaResource(
    ...
    public CharSequence getContent() {
      StringBuffer code = new StringBuffer();
      code.append("package foo;\n");
      code.append("import com.progressoft.brix.domino.i18n.client.Messages;\n");
      code.append("import com.progressoft.brix.domino.i18n.client.Messages.DefaultMessage;\n");
