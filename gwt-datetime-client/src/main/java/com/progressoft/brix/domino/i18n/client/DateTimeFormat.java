...
import com.progressoft.brix.domino.i18n.client.constants.DateTimeConstants;
import com.progressoft.brix.domino.i18n.client.impl.cldr.DateTimeFormatInfoImpl_en;
 ...
 *
 * deprecated use {@link com.progressoft.brix.domino.i18n.shared.DateTimeFormat} instead
 */
// Temporarily remove deprecation to keep from breaking teams that don't allow
// deprecated references.
// @Deprecated
public class DateTimeFormat extends com.progressoft.brix.domino.i18n.shared.DateTimeFormat {

  /**
   * Predefined date/time formats -- see {@link CustomDateTimeFormat} if you
   * need some format that isn't supplied here.
   *
   * deprecated use {@link com.progressoft.brix.domino.i18n.shared.DateTimeFormat.PredefinedFormat} instead
   */
   // Temporarily remove deprecation to keep from breaking teams that don't allow
   // deprecated references.
   // @Deprecated
  ...
  public static DateTimeFormat getFormat(PredefinedFormat predef) {
    if (usesFixedEnglishStrings(predef)) {
      ...
      switch (predef) {
        case RFC_2822:
          pattern = com.progressoft.brix.domino.i18n.shared.DateTimeFormat.RFC2822_PATTERN;
          break;
        case ISO_8601:
          pattern = com.progressoft.brix.domino.i18n.shared.DateTimeFormat.ISO8601_PATTERN;
          break;
        default:
