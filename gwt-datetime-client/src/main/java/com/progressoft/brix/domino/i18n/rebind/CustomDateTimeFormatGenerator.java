...
import com.progressoft.brix.domino.i18n.shared.CustomDateTimeFormat;
import com.progressoft.brix.domino.i18n.shared.CustomDateTimeFormat.Pattern;
import com.progressoft.brix.domino.i18n.shared.DateTimeFormat;
  ...
  public final String generate(TreeLogger logger, final GeneratorContext context,
    ...
    try {
      oldDateTimeFormat = typeOracle.getType(
          com.progressoft.brix.domino.i18n.client.DateTimeFormat.class.getName());
    } catch (NotFoundException e) {
    ...
    if (pw != null) {
      ...
      factory.addImport("com.progressoft.brix.domino.i18n.client.DateTimeFormat");
      ...
      for (JMethod method : targetClass.getMethods()) {
        ...
        if (annotation == null) {
          com.progressoft.brix.domino.i18n.client.CustomDateTimeFormat.Pattern oldAnnotation
              = method.getAnnotation(com.progressoft.brix.domino.i18n.client.CustomDateTimeFormat.Pattern.class);
