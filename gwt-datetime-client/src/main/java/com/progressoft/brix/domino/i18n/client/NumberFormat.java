 ...
 * <code><nobr>com.progressoft.brix.domino.i18n.client.constants</nobr></code>. To insert
...
public class NumberFormat {
   ...
   *     com.progressoft.brix.domino.i18n.client.constants.CurrencyCodeMapConstants.properties
   * @return a <code>NumberFormat</code> capable of producing and consuming
   *         currency format for the current locale
   ...
   * 
   * @param currencyCode valid currency code, as defined in
   *        com.progressoft.brix.domino.i18n.client
