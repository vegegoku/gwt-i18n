...
import com.progressoft.brix.domino.i18n.client.LocaleInfo;
...
public class SafeHtmlBidiFormatter extends BidiFormatterBase {
   ...
   * com.progressoft.brix.domino.i18n.client.HasDirection.Direction, String, boolean)
   *
  ...
  /**
   * @see BidiFormatter#spanWrapWithKnownDir(
   * com.progressoft.brix.domino.i18n.client.HasDirection.Direction, String, boolean, boolean)
   *
  ...
  /**
   * @see BidiFormatter#spanWrapWithKnownDir(
   * com.progressoft.brix.domino.i18n.client.HasDirection.Direction, String)
   *
   * @param dir {@code str}'s direction
   * @param str The input string
   * @return Input string after applying the above processing.
