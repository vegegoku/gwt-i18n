...
public class BidiFormatter extends BidiFormatterBase {
  ...
  /**
   * Like
   * {@link #spanWrapWithKnownDir(com.progressoft.brix.domino.i18n.client.HasDirection.Direction, String, boolean, boolean)},
  ...
  /**
   * Like
   * {@link #unicodeWrapWithKnownDir(com.progressoft.brix.domino.i18n.client.HasDirection.Direction, String, boolean, boolean)},
   * but assumes {@code isHtml} is false and {@code dirReset} is true.
   *
   * @param dir {@code str}'s direction
   * @param str The input string
