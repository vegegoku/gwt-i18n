...
import com.progressoft.brix.domino.i18n.server.keygen.MethodNameKeyGenerator;
...
public class MessageUtils {
  ...
  public static KeyGenerator getKeyGenerator(GenerateKeys keyGenAnnot)
    ...
    try {
      ...
      if (com.progressoft.brix.domino.i18n.rebind.keygen.KeyGenerator.class.isAssignableFrom(
          clazz)) {
        Class<? extends com.progressoft.brix.domino.i18n.rebind.keygen.KeyGenerator> kgClass
            = clazz.asSubclass(com.progressoft.brix.domino.i18n.rebind.keygen.KeyGenerator.class);
