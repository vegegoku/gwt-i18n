...
public class KeyGeneratorAdapter implements KeyGenerator {
  ...
  private final com.progressoft.brix.domino.i18n.rebind.keygen.KeyGenerator keygen;

  /**
   * @param keygen
   */
  public KeyGeneratorAdapter(com.progressoft.brix.domino.i18n.rebind.keygen.KeyGenerator keygen) {
    this.keygen = keygen;
  }
