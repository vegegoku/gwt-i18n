 ...
 * 
 * deprecated use {@link com.progressoft.brix.domino.i18n.shared.CustomDateTimeFormat} instead
 */
// Temporarily remove deprecation to keep from breaking teams that don't allow
// deprecated references.
// @Deprecated
public interface CustomDateTimeFormat extends com.progressoft.brix.domino.i18n.shared.CustomDateTimeFormat {
   ...
   * 
   * deprecated use {@link com.progressoft.brix.domino.i18n.shared.CustomDateTimeFormat.Pattern} instead
   */
  // Temporarily remove deprecation to keep from breaking teams that don't allow
  // deprecated references.
  // @Deprecated
